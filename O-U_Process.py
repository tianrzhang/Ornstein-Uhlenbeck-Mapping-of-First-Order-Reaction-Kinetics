...
stationary_10_gillespie = stationary_count(10, 13000000, 50, 0.5, 5)
stationary_100_gillespie = stationary_count(100, 13000000, 50, 0.01, 10)
stationary_1000_gillespie = stationary_count(1000, 1300000, 50, 0.001, 25)
...
axs[0,0].hist(split_10_fractional, bins = shared_edges_2, density = True, label = "Ornstein-Uhlenbeck", alpha = 0.5, color = "red")
axs[0,0].hist(mols_10_fractions, bins = shared_edges_2, density = True, label = "Gillespie", alpha = 0.5, color = "blue")
axs[0,0].set_title("N=10", fontsize = 9)
axs[0,0].legend(fontsize = "x-small", loc = "upper right")

axs[0,1].hist(split_100_fractional, bins = shared_edges_2, density = True, label = "Ornstein-Uhlenbeck", alpha = 0.5, color = "red")
axs[0,1].hist(mols_100_fractions, bins = shared_edges_2, density = True, label = "Gillespie", alpha = 0.5, color = "blue")
axs[0,1].set_title("N=100", fontsize = 9)
axs[0,1].legend(fontsize = "x-small", loc = "upper right")

axs[1,0].hist(split_1000_fractional, bins = shared_edges_2, density = True, label = "Ornstein-Uhlenbeck", alpha = 0.5, color = "red")
axs[1,0].hist(mols_1000_fractions, bins = shared_edges_2, density = True, label = "Gillespie", alpha = 0.5, color = "blue")
axs[1,0].set_title("N=1000", fontsize = 9)
axs[1,0].legend(fontsize = "x-small", loc = "upper right")

axs[1,1].hist(split_10000_fractional, bins = shared_edges_2, density = True, label = "Ornstein-Uhlenbeck", alpha = 0.5, color = "red")
axs[1,1].hist(mols_10000_fractions, bins = shared_edges_2, density = True, label = "Gillespie", alpha = 0.5, color = "blue")
axs[1,1].set_title("N=10000", fontsize = 9)
axs[1,1].legend(fontsize = "x-small", loc = "upper right")

fig.suptitle("Gillespie vs Ornstein-Uhlenbeck")
