...
# Results
figure/deterministic_overlay.png

A graph demonstrating at large N values, the deterministic approximation matches the Ornstein-Uhlenbeck model

figure/absolute.png

A graph demonstrating the relationship between the absolute standard deviation and N on log-log axes

figure/relative.png

A graph demonstrating the relationship between the relative staandard deviation and N on log-log axes

figure/distributions.png

A figure showing the convergence of the Ornstein-Uhlenbeck to the exact Gillespie model
# Key Findings
